...
!(function(){
    ...
    window.Calendar = (function(){
        ...
        Calendar.prototype.fetch = function(){
            ...
            if(typeof _text == "undefined") { // 判断_text是否存在，如果不存在，先加载_text文件
                this.loadText();
                return;
            };
            this.loadCss();
            ...
            $(document).queue("calendar",function(){
                // 读取模板
                _text().get(currentSrc + "/template/calendar.html",function(e){
                    self.templateList.calendarTemp = e;
            ...
            $(document).queue("calendar",function(){
                // 读取模板
                _text().get(currentSrc + "/template/list.html",function(e){
                    self.templateList.daysTemp = e;
                    // 获取本年的所有日期
         ...
         * 加载text.js文件
         */
        Calendar.prototype.loadText = function(){
            var script = document.createElement("script"); 
            script.setAttribute("type","text/javascript"); 
            script.setAttribute("src",currentSrc.replace(/calendar$/,"text/text.js"));
